function robot_param=dynNS_Force2(u)
...
nx2=Ixx2*s2*ddq1+(Ixx2-Iyy2+Izz2)*c2*dq1*dq2+[Ixx3*s2*ddq1+(Ixx3+Iyy3-Izz3)*c2*dq1*dq2]+0.5*d2*(-0.5*d2*m2*s2*ddq1+g*m2*c2)+...
    (0.5*l3-q3)*[0.5*l3*m3*(s2*ddq1+2*c2*dq1*dq2)+m3*(-q3*s2*ddq1*2*q3*c2*dq1*dq2+d2-dq1^2-2*s2*dq1*dq3)];
ny2=Iyy2*c2*ddq1+(Ixx2-Iyy2-Izz2)*s2*dq1*dq2+Izz3*c2*ddq1+(Ixx3-Iyy3-Izz3)*s2*dq1*dq2-0.5*d2*(0.5*d2*m2*c2*ddq1+g*m2*s2);
nz2=[-d2*m3*c2*(0.5*l3+q3)]*ddq1+[Izz2+Iyy3+m3*(0.25*l3^2+l3*q3+q3^2)]*ddq2-s2*c2*(Ixx2+Ixx3-Iyy2-Izz3+...
    m3*(0.25*l3^2-l3*q3+q3^2))*dq1^2+m3*(-l3+2*q3)*dq2*dq3-m3*(l3+2*q3)*dq2*dq3+m3*g*s2*(0.5*l3-q3);
