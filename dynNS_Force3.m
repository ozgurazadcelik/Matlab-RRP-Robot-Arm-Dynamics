tfunction robot_param=dynNS_Force3(u)
...
M11=Izz1+00.25*l3^2-l3*q3+q3^2))+c2^2*(Iyy2+Izz3)+m3*d2^2;
...
% 
% 
% %%% Linear and Angular Forces on Second Joint
% 
% 
% fx2=c2*[0.5*d2*m2*c2*ddq1+g*m2*s2-0.5*l3*m3*s2*c2*dq1^2+0.5*l3*m3*ddq2+m3*(-q3*ddq2+q3*s2*c2*dq1^2+d2*c2*ddq1+g*s2-2*dq2*dq3)];
% fy2=-0.5*d2*m2*s2*ddq1+g*m2*c2+0.5*l3*m3*(s2^2*dq1^2+dq2^2)+m3*(-q3*(s2^2*dq1^2+dq2^2)-d2*s2*ddq1+g*c2+ddq3);
% fz2=-0.5*d2*m2*dq1^2-[0.5*l3*m3*(s2*ddq1+2*c2*dq1*dq2)+m3*(-q3*s2*ddq1-2*q3*c2*dq1*dq2+d2*dq1^2-2*s2*dq1*dq3)];
% 
% 
% nx2=Ixx2*s2*ddq1+(Ixx2-Iyy2+Izz2)*c2*dq1*dq2+[Ixx3*s2*ddq1+(Ixx3+Iyy3-Izz3)*c2*dq1*dq2]+0.5*d2*(-0.5*d2*m2*s2*ddq1+g*m2*c2)+(0.5*l3-q3)*...
%     [0.5*l3*m3*(s2*ddq1+2*c2*dq1*dq2)+m3*(-q3*s2*ddq1*2*q3*c2*dq1*dq2+d2-dq1^2-2*s2*dq1*dq3)];
% ny2=Iyy2*c2*ddq1+(Ixx2-Iyy2-Izz2)*s2*dq1*dq2+Izz3*c2*ddq1+(Ixx3-Iyy3-Izz3)*s2*dq1*dq2-0.5*d2*(0.5*d2*m2*c2*ddq1+g*m2*s2);
% nz2=[-d2*m3*c2*(0.5*l3+q3)]*ddq1+[Izz2+Iyy3+m3*(0.25*l3^2+l3*q3+q3^2)]*ddq2-s2*c2*(Ixx2+Ixx3-Iyy2-Izz3+m3*(0.25*l3^2-l3*q3+q3^2))*...
%     dq1^2+m3(-l3+2*q3)*dq2*dq3-m3*(l3+2*q3)*dq2*dq3+m3*g*s2*(0.5*l3-q3);
% 
% F2=[fx2;fy2;fz2];
% N2=[nx2;ny2;nz2];
% 
...
%%% Linear and Angular Forces on Third Joint


fx3=-0.5*l3*m3*s2*c2*dq1^2+0.5*l3*m3*ddq2+m3*(-q3*ddq2+q3*s2*c2*dq1^2+d2*c2*ddq1+g*s2-2*dq2*dq3);
fy3=0.5*l3*m3*(s2*ddq1+2*c2*dq1*dq2)+m3*(-q3*s2*ddq1-2*q3*c2*dq1*dq2+d2*dq1^2-2*s2*dq1*dq3);
fz3=[-d2*m3*s2]*ddq1+m3*ddq3+m3*s2^2*(0.5*l3-q3)*dq1^2+m3*(0.5*l3-q3)*dq2^2+m3*g*c2;

nx3=Ixx3*s2*ddq1+(Ixx3+Iyy3-Izz3)*c2*dq1*dq2+0.5*l3*[0.5*l3*m3*(s2*ddq1+2*c2*dq1*dq2)+m3*(-q3*s2*ddq1-2*q3*c2*dq1*dq2+d2*dq1^2-2*s2*dq1*dq3)];
ny3=-Iyy3*ddq2+(Ixx3-Izz3)*s2*c2*ddq1^2-0.5*l3*[-0.5*l3*m3*s2*c2*dq1^2+0.5*l3*m3*ddq2+m3*(-q3*ddq2+q3*s2*c2*dq1^2+d2*c2*ddq1+g*s2-2*dq2*dq3)];
